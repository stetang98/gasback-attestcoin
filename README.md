...
| Public app | [GasBack](https://stetang98.github.io/gasback-attestcoin/); GitHub Pages deployed; live proof/native/payment verification passed, showing REBATE PAID and 1.0 test CTC with replay blocked |
...
| PDF deck | [Six-page evidence deck](https://stetang98.github.io/gasback-attestcoin/GasBack-deck.pdf); anonymous HTTP 200 and exact local/public SHA-256 match |
| Peter V3 demonstration | [Video page](https://stetang98.github.io/gasback-attestcoin/demo.html) · [MP4](https://stetang98.github.io/gasback-attestcoin/demo.mp4) · [SRT](https://stetang98.github.io/gasback-attestcoin/demo.srt); anonymous HTTP and hash checks passed; public V3 playback reached 110.08 s with ended=true and no media error |
| DoraHacks entry | [GasBack — BUIDL 48594](https://dorahacks.io/buidl/48594), submitted to BUIDL CTC 2026 Fall and **Under Review (not publicly visible yet)**, track DeFi. Submission receipt is confirmed; judging approval and an award are not. Organizer eligibility is self-declared, not independently verified; future prize eligibility and payment remain unresolved |

GitHub Pages is live. All seven release files returned anonymous HTTP 200 and matched the local canonical hashes. The public app verified the real proof, native verifier and linked payment, displaying REBATE PAID, 1.0 test CTC and blocked replay. Peter V3 public playback reached currentTime=duration=110.08 s, ended=true, paused=true, readyState=4 and error=null; currentSrc identified demo.mp4?v=peter-v3. No full human listening acceptance is recorded. See [GitHub Pages release checks](docs/qa/github-pages-release-check.json), [release validation](docs/submission/validation.md) and [video production record](docs/qa/chatcut-v2-edit-summary.md). DoraHacks displayed BUIDL Submitted! and Under Review (not publicly visible yet) for the [entry](https://dorahacks.io/buidl/48594); it may be edited before judging.
